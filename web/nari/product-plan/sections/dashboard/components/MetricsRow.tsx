import { LuTrendingUp as TrendingUp, LuTrendingDown as TrendingDown, LuShoppingBag as ShoppingBag, LuBookOpen as BookOpen, LuLandmark as Landmark } from 'react-icons/lu'
    ...
    <div className="grid grid-cols-2 gap-3">
      ...
      <div className="bg-white dark:bg-stone-900 rounded-2xl border border-stone-200 dark:border-stone-800 p-4 shadow-sm dark:shadow-none">
        <div className="flex items-center justify-between mb-3">
          ...
          <BookOpen className="w-4 h-4 text-stone-300 dark:text-stone-600" />
        </div>
      ...
      <div className="bg-white dark:bg-stone-900 rounded-2xl border border-stone-200 dark:border-stone-800 p-4 shadow-sm dark:shadow-none">
        <div className="flex items-center justify-between mb-3">
          ...
          <Landmark className="w-4 h-4 text-stone-300 dark:text-stone-600" />
        </div>
