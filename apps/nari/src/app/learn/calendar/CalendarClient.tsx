                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {event.sessionId && (
                          <Link
                            href={`/learn/sessions/${event.sessionId}`}
                        ...
                        {event.courseId && !event.sessionId && (
                          <Link
                            href={`/learn/courses/${event.courseId}`}
                            className="text-xs text-primary hover:text-primary/80 mt-1 inline-block transition-colors"
                          >
                            Go to course →
                          </Link>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-1.5 flex gap-3">
                          {event.sessionId && (
                            <Link href={`/learn/sessions/${event.sessionId}`} className="text-xs text-primary hover:text-primary/80 transition-colors">
                              View session →
                            </Link>
                          )}
                          {event.courseId && !event.sessionId && (
                            <Link href={`/learn/courses/${event.courseId}`} className="text-xs text-primary hover:text-primary/80 transition-colors">
                              Go to course →
                            </Link>
                          )}
                          {isThisMonth && (
