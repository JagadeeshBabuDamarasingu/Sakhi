...
export function QuickActions({ onCreateListing, onGoLive, onPreviewStorefront }: QuickActionsProps) {
  return (
    <div className="flex flex-wrap gap-3 mb-8">
      ...
      <button
        ...
        className="group inline-flex items-center gap-2 px-4 py-3 bg-base-200 hover:bg-base-300 text-base-content/70 text-sm font-medium rounded-xl transition-colors"
      >
        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
