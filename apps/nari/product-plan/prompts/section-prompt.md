...
- **SECTION_NAME** = [Human-readable name, e.g., "Dashboard" or "Skill Discovery"]
- **SECTION_ID** = [Folder name in sections/, e.g., "dashboard" or "skill-discovery"]
...
3. **Integration Points**
   ...
   - For Marketplace: ONDC integration details?
   - For Financing: OCEN/lender partner details?
